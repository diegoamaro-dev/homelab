...
8. **ER-1 — Deterministic Entity Resolution** — **design FROZEN 2026-07-16; implementation
   in progress (ER-1.0 at the git gate).** Natural-language requests do not resolve to real
