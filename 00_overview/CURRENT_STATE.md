...
8. **ER-1 — Deterministic Entity Resolution** — **design FROZEN 2026-07-16 (now Revision 2);
   implementation in progress. ER-1.0 committed + pushed (`c147e632` → `38eb8262`); the
   Revision 2 amendment (D-ER-11 + D-ER-12) is at the git gate.** Natural-language requests do not resolve to real
