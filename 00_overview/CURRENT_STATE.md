...
8. **ER-1 — Deterministic Entity Resolution** — **design FROZEN 2026-07-16 (now Revision 4);
   ...
   2026-07-20 — at the git gate; G-ER-2/3a/3b/4 + G-ER-7 write half + G-ER-6 consumer half
   (write side) all PASS. Next: ER-1.5 (closeout).** **The read path (ER-1.4a) and the write
